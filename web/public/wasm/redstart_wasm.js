 ...
 * @param {string} source
 * @param {string} abis_json
 * @returns {any}
 */
export function compile(source, abis_json) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(abis_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('redstart_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
